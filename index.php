...
<html lang="en">
  ...
  <h1><small>NXDNReflector-Dashboard by IU7IGU for Reflector:</small>  <?php echo NXDNREFLECTORNAME; ?></h1>
...
echo "NXDNReflector-Dashboard V ".VERSION." | Last Reload ".$lastReload->format('Y-m-d, H:i:s')." (".TIMEZONE.")";
$time = microtime();
$time = explode(' ', $time);
$time = $time[1] + $time[0];
$finish = $time;
...
?> | get your own at: <a href="https://github.com/IU7IGU/NXDNReflector-Dashboard">https://github.com/IU7IGU/NXDNReflector-Dashboard</a>
	</div>
  </body>
</html>
